    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="mobile-footer">
          <div className="footer-top-row">
            <div className="footer-brand">
              <h3 className="footer-title">
                Bismi Fresh Foods <FaHeart className="icon heart" />
              </h3>
            ...
            <div className="footer-social">
              <button
                ...
                onClick={() =>
                  window.open(
                    "https://www.youtube.com/@khaderali8379",
                    "_blank"
                  )
                }
              >
              ...
              <button
                ...
                onClick={() =>
                  window.open(
                    "https://instagram.com/bismi_fresh_foods_",
                    "_blank"
                  )
                }
              >
              ...
              <button
                ...
                onClick={() =>
                  window.open(
                    "https://facebook.com/khader.khaderali.9",
                    "_blank"
                  )
                }
              >
          ...
          {/* Leadership Info for Mobile */}
          <div className="leadership-info">
            <h4 className="footer-heading">Our Leadership</h4>
            <div className="leadership-container">
              <p className="leadership-text">
                <strong className="leadership-text-name">
                  K K Jabreen Afreen
                </strong>
                <br />
                 Proprietor
              ...
              <p className="leadership-text">
                <strong className="leadership-text-name">Khader Ali</strong>
                <br />
                CEO
              </p>
            </div>
          ...
          <p className="footer-quote">
            © 2024 Bismi Fresh Foods. All rights reserved.
          </p>
        </div>
        ...
        <div className="desktop-footer">
          <div className="footer-grid">
            ...
            <div className="footer-section">
              ...
              <div className="contact-row">
                <FaPhoneAlt className="icon" />
                <a href="tel:+916300414449" className="contact-number">
                  +91 63004 14449
                </a>
              </div>
              <div className="contact-row">
                ...
                <a
                  href="mailto:khaderali.1988@gmail.com"
                  className="contact-number"
                >
                  khaderali.1988@gmail.com
                </a>
              </div>
              <div className="contact-row">
                <FaMapMarkerAlt className="icon" />
                <span>
                  No.14 G 1133, <br /> Goolingspet Street, Chittoor <br />{" "}
